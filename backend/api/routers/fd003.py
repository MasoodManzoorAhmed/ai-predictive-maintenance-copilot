# backend/api/routers/fd003.py
"""
FD003 RUL prediction router (thin but strict).
"""

from fastapi import APIRouter, HTTPException
import pandas as pd

from backend.api.models.requests import FD003BatchRequest
from backend.api.models.responses import FD003PredictionResponse, EnginePrediction
...
@router.post("/fd003", response_model=FD003PredictionResponse)
def predict_fd003(request: FD003BatchRequest):
    try:
        ...
        if not too_short.empty:
            ...
            raise HTTPException(
                status_code=400,
                detail=(
                    f"FD003 batch prediction requires at least {seq_len} cycles per unit. "
        ...
        out = run_fd_inference("FD003", df_input=df, allow_padding=False)
        ...
        return FD003PredictionResponse(
            fd_name="FD003",
