...
DATA_PATH = Path("data/cmapps/train_FD003.txt")
...
# mid window (avoid near-failure = low RUL)
START_CYCLE = 50
...
Path("fd003_batch_swagger.json").write_text(json.dumps(batch_payload, indent=2))
print(" Wrote:", Path("fd003_batch_swagger.json").resolve())
...
Path("fd003_single_swagger.json").write_text(json.dumps(single_payload, indent=2))
print(" Wrote:", Path("fd003_single_swagger.json").resolve())
